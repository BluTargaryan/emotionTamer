...
const alternateNostrilsStageExhaleRight = () => {
    ...
    useEffect(() => {
        if (countdown === 0) {
            router.replace(`/(alternateNostrils)/alternateNostrilsStageInhaleRight?totalCycles=${totalCyclesNum}&currentCycle=${currentCycleNum}` as any);
        }
    }, [countdown]);
...
export default alternateNostrilsStageExhaleRight 