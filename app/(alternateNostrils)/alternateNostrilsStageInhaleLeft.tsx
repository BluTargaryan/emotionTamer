...
const alternateNostrilsStageInhaleLeft = () => {
    ...
    useEffect(() => {
        if (countdown === 0) {
            router.replace(`/(alternateNostrils)/alternateNostrilsStageHoldLeft?totalCycles=${totalCyclesNum}&currentCycle=${currentCycleNum}` as any);
        }
    }, [countdown]);
...
export default alternateNostrilsStageInhaleLeft 