...
const alternateNostrilsStageHoldRight = () => {
    ...
    useEffect(() => {
        if (countdown === 0) {
            router.replace(`/(alternateNostrils)/alternateNostrilsStageExhaleLeft?totalCycles=${totalCyclesNum}&currentCycle=${currentCycleNum}` as any);
        }
    }, [countdown]);
...
export default alternateNostrilsStageHoldRight 